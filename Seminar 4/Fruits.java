...
public class Fruits {
    ...
    public static void shiftBox(Box b1, Box b2) {
        System.out.printf("\nПересыпаем фрукты из коробки №%d в коробку №%d:\n", b1.getId(), b2.getId());
        if ((b1.name.equals(b2.name) || b2.name.equals("пусто")) && b1.fruits.size() > 0) {
            ...
            System.out.println("Это коробки с разными фруктами или первая коробка пустая, пересыпать нельзя\n");
    }
...
class Box<T extends Fruit> {
    ...
    public String toString() {
        return "Коробка №" + id + " - Фрукты: " + name + " - Вес: " + weight + "кг";
    }
